<?php		
	...
	{	
		echo "<li>".HTML::anchor('#', 'Análise' , array("class" => 'menu_dropdown', 'onclick' => 'openMenu("menu_analise")' , 'id' => 'menu_analise'  ) );
			echo "<ul>";
				//if(Site::isGrant(array('access_inspecao'))) nao tem um privilegio necessario pra isso existir
				...
				//if(Site::isGrant(array('access_grauderisco'))) idem
		...
		if(Site::isGrant(array('access_relatorios')))
			echo "<li>".HTML::anchor('#', 'Relatórios' , array("class" => 'menu_dropdown', 'onclick' => 'openMenu("menu_relatorio")' , 'id' => 'menu_relatorio'  ) );
					echo "<ul>";							
							...
							echo "<li>".HTML::anchor('relatorios/upload', "Upload de Relatórios" , array("class" => Site::active("relatorio_upload",3,false) ) ). "</li>";					
					echo "</ul>";
			echo "</li>";
	}
