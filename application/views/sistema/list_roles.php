			...
			foreach ($objs as $o) {				
				echo "<tr>";
					...
					echo "<td><div class='btn-group btn-group-lg'>";
						echo html::anchor("sistema/edit_roles/".$o->id,"EDITAR", array("class"=>"btn btn-info"));						
...
<?php } else echo "<div class='alert alert-warning tabela_vazia'>Nenhum grupo de acesso encontrado.</div>"; ?>
...
<script type="text/javascript">
	...
	{
		$.ajax({
			url : "<?php echo site::baseUrl() ?>sistema/delete_roles",
			type: "POST",  
  			data: { id: id},
