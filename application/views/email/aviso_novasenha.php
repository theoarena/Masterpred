<div style='background-color:#f1f1f1;padding:10px;color:#444444;font-family:Verdana'>
	...
	<p style="margin:0"><a href='<?php echo Kohana::config('config.endereco_site'); ?>'>Clique aqui</a> para acessar o sistema e desfrutar de todas as suas funcionalidades.</p>
	<p style="margin:0">&nbsp;</p>
